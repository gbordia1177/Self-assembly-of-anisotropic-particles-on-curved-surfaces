...
equil_file = "./equilfiles/Seesaw/PosHarmonic2DWavePatchyParticlesSeesaw_N_" + str(N) + "_phi_" + str(phi) + "_theta_" + str(theta) + "_epsP_" + str(eps_p) + "_k_" + str(k) + "_delh_" + str(delh) + "_q_"+str(period)+  "_even_" + str(even) + "_.gsd"
...
N_P = 4*N_C #number of patch particles
#print(N_C)
#print(N_P)
#print(P)
numPperC = 4 + 1
