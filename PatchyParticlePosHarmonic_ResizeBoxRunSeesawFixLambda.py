...
# write output
log_file = "./logfiles/Seesaw/FixLambda/PosHarmonic2DWavePatchyParticlesSeesawFixLambda_N_" + str(N) + "_phi_" + str(phi_new) + "_P_" + str(P) + "_epsP_" + str(eps_p) + "_k_" + str(k) + "_delh_" + str(delh)  + "_lambda_" + str(wavelength) +"_.gsd"
gsd_file = "./trajectories/Seesaw/FixLambda/PosHarmonic2DWavePatchyParticlesSeesawFixLambda_N_" + str(N) + "_phi_" + str(phi_new) + "_P_" + str(P) + "_epsP_" + str(eps_p) + "_k_" + str(k) + "_delh_" + str(delh) + "_lambda_" + str(wavelength) + "_.gsd"
restart_file = "./restartfiles/Seesaw/FixLambda/restart_PosHarmonic2DWavePatchyParticlesSeesawFixLambda_N_" + str(N) + "_phi_" + str(phi_new) + "_P_" + str(P) + "_epsP_" + str(eps_p) + "_k_" + str(k) + "_delh_" + str(delh) + "_lambda_" + str(wavelength) + "_.gsd"
equil_file = "./equilfiles/Seesaw/FixLambda/PosHarmonic2DWavePatchyParticlesSeesawFixLambda_N_" + str(N) + "_phi_" + str(phi_new) + "_P_" + str(P) + "_epsP_" + str(eps_p) + "_k_" + str(20.0) + "_delh_" + str(delh) + "_lambda_" + str(wavelength) + "_.gsd"
