...
equil_file = "./equilfiles/FixLambda/PosHarmonic2DWavePatchyParticlesFixLambda_N_" + str(N) + "_phi_" + str(phi_new) + "_P_" + str(P) + "_epsP_" + str(eps_p) + "_k_" + str(k) + "_delh_" + str(delh) + "_lambda_" + str(wavelength) + "_.gsd"
