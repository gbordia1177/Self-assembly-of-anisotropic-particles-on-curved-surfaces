...
# write output
log_file = "./logfiles/FixPhi/PosHarmonic2DWavePatchyParticles_N_" + str(N) + "_phi_" + str(phi) + "_P_" + str(P) + "_epsP_" + str(eps_p) + "_k_" + str(k) + "_delh_" + str(delh) + "_q_"+str(period)+ "_even_" + str(even) + "_.gsd"
gsd_file = "./trajectories/FixPhi/PosHarmonic2DWavePatchyParticles_N_" + str(N) + "_phi_" + str(phi) + "_P_" + str(P) + "_epsP_" + str(eps_p) + "_k_" + str(k) + "_delh_" + str(delh) + "_q_"+str(period)+  "_even_" + str(even) + "_.gsd"
restart_file = "./restartfiles/FixPhi/restart_PosHarmonic2DWavePatchyParticles_N_" + str(N) + "_phi_" + str(phi) + "_P_" + str(P) + "_epsP_" + str(eps_p) + "_k_" + str(k) + "_delh_" + str(delh) + "_q_"+str(period)+  "_even_" + str(even) + "_.gsd"
equil_file = "./equilfiles/FixPhi/PosHarmonic2DWavePatchyParticles_N_" + str(N) + "_phi_" + str(phi) + "_P_" + str(P) + "_epsP_" + str(eps_p) + "_k_" + str(20.0) + "_delh_" + str(delh) + "_q_"+str(period)+  "_even_" + str(even) + "_.gsd"
...
def doubleTrigonalPlanar(P, sigma, radius): return np.asarray([(0, radius, 0 ), (- (3**(0.5)) /2*radius, -1/2*radius, 0 ), ((3**(0.5)) /2*radius, -1/2*radius, 0 ),
                                                               (0, 0, radius ), (- (3**(0.5)) /2*radius, 0, -1/2*radius ), ((3**(0.5)) /2*radius, 0, -1/2*radius)])
...
nl=hoomd.md.nlist.Cell(buffer = 0.45, exclusions = ['body'])
